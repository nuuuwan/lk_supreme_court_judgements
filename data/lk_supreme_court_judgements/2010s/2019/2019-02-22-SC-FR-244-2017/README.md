...
Respondents (the Respondents) that the Petitioners application to this Court is time barred.

The respondents raised the above preliminary objection, when this application in which

the petitioners alleged that their fundamental rights were infringed by the respondents failure to
...
In the above circumstances, the petitioners contention that they went before the Human
...
alleging infringement of the petitioners and such other similarly circumstanced persons
...
period of limitation or for any other intention or an ulterior motive. Thus, Kithsiris case referred
...
Commission, culminating in a communiqu pertaining to the findings on the complaint. An
...
Ranaweeras case since the respondent in its objections raised the plea of time bar and the
...
above said Ranaweeras case, that in exercising the fundamental rights jurisdiction this Court is
