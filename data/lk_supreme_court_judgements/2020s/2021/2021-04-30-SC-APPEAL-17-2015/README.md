...
22(7) of the Rent Act. He sought dismissal of the Plaintiffs
...
that the Plaintiffs mother, who alienated the premises to the
...
Defendant in his answer disputes the Plaintiffs ownership of

the premises (and thereby denies tenancy), the Defendant is

disentitled to the protection of the Rent Act. This is the

crucial issue in this case. The Defendants reliance on the
...
was right in dismissing the Plaintiffs action (page 65 of the
...
the Plaintiffs appeal with costs.
...
Learned Presidents Counsel for the Defendant strenuously
...
I would have agreed with the learned Presidents Counsel in
...
arising out of the Defendants issues. What the Plaintiff did

was not unusual. There are ample authorities to support the

course of action adopted by the Plaintiff. However, learned

Presidents Counsel submits that in those cases, unlike in the
...
cessation of Simons life-interest, the Defendants
...
Premadharma (supra). In Kanthasamys case the Plaintiff
...
Defendant upon the Defendants denial of tenancy. The
...
Defendants denial of tenancy. This is erroneous.
...
The tenant cannot question the landlords ownership of the
...
7, 8 and 12 of the answer, admits that: (a) the Plaintiffs

father was his landlord; (b) upon the death of the Plaintiffs
...
prove the Plaintiffs ownership of the premises and on that
...
dismiss the Plaintiffs action by application of section 22(7) of
