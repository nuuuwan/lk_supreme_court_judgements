...
as Millagahawatta did not contest the plaintiffs title deeds.

Throughout the action her position was that the plaintiffs title deeds
...
and the originals were produced at the trial. Her transferors title
...
plaintiffs title deed No. 6952 of 06.09.1992 (P8) is as follows:
...
the execution of the plaintiffs deed or after the institution of this
...
The transferor of the plaintiffs deed No. 6952 (P8), Riyal, became
...
Learned Presidents counsel for the plaintiff quoting Balasooriya v.
...
the issue is the identification of the plaintiffs land on the ground.

Hence those two cases are inapplicable here.

The plaintiff admits that the plaintiffs land is registered at the Land

Registry in one folio (page 384 of the brief) and the defendants land
...
and to superimpose the defendants plan thereon. This has not been
...
and the High Court and allow the appeal. The plaintiffs action shall
