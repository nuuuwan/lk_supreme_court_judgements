...
Ltd) the PetitionerRespondent before this Court, appointed the Petitioner, Green
...
in terms of Rule 17 and 19 and called for the liquidators report.
...
Responding to the aforesaid submissions, the learned Presidents Counsel for Green
...
Though Kushani Nanayakkaras signature appears in the proxy and there is a rubber
...
initially appeared for the plaintiff, upon the plaintiffs death moved for substitution and
...
The Petitioners next point of argument was that a defective proxy can be cured. It is
...
The above extract from the Registrars Books also indicate that three other
...
Countering the said submissions, the Learned Presidents Counsel for the Petitioner
