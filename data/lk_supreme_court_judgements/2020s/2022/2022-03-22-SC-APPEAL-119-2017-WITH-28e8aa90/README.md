...
A risk analysis of a port facilitys operation in order to determine its risk to be the
...
port facility and ships, persons and Cargo, Cargo transport units and Ships stores
...
b. Detail of Port Facilitys link with other relevant authorities and the necessary
...
f. Detail reporting procedures to government of Sri Lankas contact points.
...
that the Respondents employees prevented Claimant 1 from carrying out the
...
16 Alan Redfern and Martin Hunter with Nigel Blackaby and Constantine Partasides; (2004), 4th Edition, London: Sweet & Maxwell, at page 248 (paragraph 5-30). 17 In some states, such as Chile, some matters must be referred to arbitration (see Jorquiera & Helmlinger, Chile in International Arbitration in Latin America (Blackaby, Lindsey & Spinillo eds), p.95. It is questionable whether such compulsory arbitration is in fact arbitration in the true sense of the word since it lacks the necessary element of consent. Such arbitrations are outside the scope of this book. 18 See, e.g., French Code of Civil Procedure 1981, Art.1502.3. 19 Under the ICC Arbitration Rules, Art. 18, an arbitral tribunal must draw up its own Terms of Reference for signature by the parties and the tribunal and for approval by the ICCs Court, before proceeding with the arbitration. 20 SC/LA No. 28/2000, decided on 25-11-2002. [Reported in 2002 BALR 23 and also in Cabrals ALR (Vol I)].
...
21 The addition of the phrase within brackets is mine. 22 SC Appeal 38/2006, SC Appeal 39/2006 decided on 25-06-2013, [Cabrals ALR (Vol I) 547].
...
HNB to pay SOUL, on the basis of latters counter-claim, a sum of money found to be the

amount of loss suffered by SOUL due to HNBs failure to insure the Apogee Speaker system,
...
altogether inconsistent with SOULs conduct and pleadings.
...
Apogee Speaker system or the payment of its agreed value, was created by the tribunals
...
USD 30,000/- at the time of submitting security manuals and the nal payment of USD
...
specic pleadings in the Notice of Arbitration, Statement of Claim and the issues raised by the
...
to any specic legal provisions or a specic clause in the agreement, the inquiry by the

Arbitrators cannot expand to examine clause 10.3 as the said clause is applicable only to a

specic factual positions i.e.:
...
Claimants had failed to fulll their obligations. Therefore, in the backdrop of the two rival
...
during the last stages of the Agreements validity/operational period, (the Agreement was to
...
to receive payment for the specic work that they have performed (on a ratable proportion
...
who wanted arbitrators to go into the questions of the claimants entitlement as per the
