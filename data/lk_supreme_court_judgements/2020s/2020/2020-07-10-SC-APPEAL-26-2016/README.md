...
application in limine on 28.07.2014 on the grounds that the Respondents
...
Court thought that there was merit in the Respondents application, the only
...
reason or the proper exercise of the judges discretion or where he has
...
It is also to be noted that the Respondents predecessor in title, Liyanage
...
roadway, and the Respondents position is that she did not take part in
...
(f) By the said impugned order the Petitioners and the Defendants right
...
Respondents application for revision and granting reliefs thereof.
...
when the Land Registry was searched before plaintiffs purchase
...
X9Accordingly, it would meet the ends of justice if without
...
Respondents application for revision and granting relief thereof.
