...
05.02.2010, the Respondent informed the Appellant that due to the Appellants
...
there was no termination of Respondents services as alleged?
...
legal result of the workmans total refusal to comply with a disciplinary order made
...
The main thrust of the Respondents argument is that the impugned transfer order
...
permitted to get a defending officer from within the Appellants establishment
...
an order should prove the allegation of bad faith to the courts satisfaction.

This is quite a difficult task to do and it is only in an exceptional fact-situation

that such plea can be substantiated to the courts satisfaction.
...
Limited v. Rasanayagam (Supra.)]; reversion of a workmans post to his former
